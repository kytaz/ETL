...
def save_to_google_sheets(df, json_keyfile='project-etl-460308-464de4f7c024.json', sheet_url='https://docs.google.com/spreadsheets/d/1D2k3gybmOADPQOeXZfOi_xnLNaLrkA1fErpLVoGteLU'):
    try:
